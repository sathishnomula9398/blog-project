...
#send_mail('Hello', 'Very imp msg....','sathishnomula0@gmail.com',['babuarrolla1@gmail.com','varaprasad5040@gmail.com'])
...
def mail_send_view(request,id):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            send_mail(subject, message, 'sathishnomula0@gmail.com', [cd['to']]) #use[] or ()tuple
            sent=True;
    else:
	    form=EmailSendForm()
